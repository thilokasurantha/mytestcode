...
class RegistrationForm :
    ...
    def registration_form(self) :
        ...
        self.close = Button(frame_4, text="BACK", font=("Source Sans Pro",12,'bold'), command=self.black_window)
    ...
    def genarate_form(self) :
        ...
        if answer :
            ...
            subject = marks.InsertMarks(Tk(), f)
            subject.form()

    def black_window(self) :
        StudentReg = options.StudentOptionGUI(Tk())
