...
class ComputerGame :
    def __init__(self,computer_game) :
        self.cmp_game = computer_game
    ...
    def computer_game_form(self) :
        self.start_computer_lable = Label(self.cmp_game, image=self.computer_img)
        self.start_computer_lable.grid(row=1)